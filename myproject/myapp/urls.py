...
from .views import (
    ...
    BecomeOwnerView, update_milestone_points, DenyMilestoneView,
    ProjectCreateView, ProjectDetailView, ProjectUpdateView, initiate_payment,
    update_payment_status, add_github_url,ProjectListView
)
...
urlpatterns = [
    ...
    path('account/<str:username>/', account_view, name='account_with_username'),
    ...
    path('milestone/deny/<int:pk>/', DenyMilestoneView.as_view(), name='deny_milestone'),
    path('project/<int:pk>/add_github_url/', add_github_url, name='add_github_url'),
    ...
    path('projects/<int:pk>/initiate_payment/<int:participant_id>/', initiate_payment, name='initiate_payment'),
    path('payment_request/<int:pk>/update_status/<str:status>/', update_payment_status, name='update_payment_status'),
    path('update_milestone_points/', update_milestone_points, name='update_milestone_points'),
]